...
<div class="index-content">
    ...
    <form action="bingfangEdit" method="post" onsubmit="return check()">
        ...
        <table class="index-content-table-add">
            <tr>
                <td width="12%">病房号：</td><td><input class="index-content-table-td-add" type="text" id="bingfangNo" name="bingfangNo" value="${vo.bingfangNo}"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                   ...
                   <input name="bingfangType" type="radio" value="重症" ${vo.bingfangType=='重症'?'checked':''}/>&nbsp;&nbsp;&nbsp;重症&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="12%">价格：</td><td><input class="index-content-table-td-add" type="text" id="bingfangPrice" name="bingfangPrice" value="${vo.bingfangPrice}"/></td>
            </tr>
            <tr>
                <td width="12%">详情：</td><td><textarea id="bingfangText" name="bingfangText" style="width: 60%; height: 100px;padding: 0px 17px;" placeholder="请输入内容......">${vo.bingfangText}</textarea></td>
            </tr>
        </table>
        <br>
        <br>
