/*
 ...
 Source Schema         : carport

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 23/03/2023 18:12:14
*/
...
CREATE TABLE `card`  (
  ...
  `cardnum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卡号',
  `type` int(11) NULL DEFAULT NULL COMMENT '卡类型',
  `money` double(11, 2) NULL DEFAULT 0.00 COMMENT '余额',
  `time` datetime NULL DEFAULT NULL COMMENT '发卡时间',
  `islose` int(11) NULL DEFAULT 0 COMMENT '是否挂失',
  `illegalcount` int(11) NULL DEFAULT 0 COMMENT '违规次数',
  `carnum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '假如没有办卡那么就用车牌来标识',
  `deductedtime` datetime NULL DEFAULT NULL COMMENT '扣费时间',
...
INSERT INTO `card` VALUES (20, '1510016655120230307', 1, 100.00, '2023-03-07 16:57:00', 0, 0, NULL, NULL);
...
CREATE TABLE `cardtype`  (
  ...
  `type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卡类型',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `coupon`  (
  ...
  `couponNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '优惠券号码',
  `money` int(11) NULL DEFAULT NULL COMMENT '优惠金额',
  `cardnum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卡号',
  `time` datetime NULL DEFAULT NULL COMMENT '过期时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of coupon
-- ----------------------------
INSERT INTO `coupon` VALUES (17, '1166586e15074ba78f67945bec04d990', 500, '1234567891020180420', '2023-03-01 11:30:30');
INSERT INTO `coupon` VALUES (18, 'd0cb9212eae3493990c6749847075065', 500, '18734542934420180422', '2023-03-13 11:30:30');
INSERT INTO `coupon` VALUES (21, '6011976fd2084a1eb4fab16ef5258232', 500, '18734542934420180422', '2023-03-13 11:31:18');
INSERT INTO `coupon` VALUES (22, '6ac70541f75e4aafb1f13aa582b35630', 500, '1234567891020180420', '2023-03-13 11:31:18');
INSERT INTO `coupon` VALUES (23, 'fee9b6fe9bbe4c259027ccf681ac5fa1', 500, '1358610158820180509', '2023-03-13 07:46:14');
...
CREATE TABLE `depotinfo`  (
  ...
  `hourmoney` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '停车场名',
  `monthcard` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '停车场电话',
  `yearcard` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '停车场地址',
  `illegal` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '总车位',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `email`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sendid` int(11) NULL DEFAULT NULL COMMENT '发送方',
  `toid` int(11) NULL DEFAULT NULL COMMENT '接收方',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标题',
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '内容',
  `time` datetime NULL DEFAULT NULL COMMENT '发送时间',
  `managerisread` int(11) NULL DEFAULT 0,
  `userisread` int(11) NULL DEFAULT 0 COMMENT '是否被读',
  `userdeleted` int(11) NULL DEFAULT 0,
  `managedelete` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of email
-- ----------------------------
INSERT INTO `email` VALUES (1, 33, 1, '扣费', '乱收费', '2023-03-13 21:55:01', 2, 0, 0, 0);
INSERT INTO `email` VALUES (2, 3, 33, '回复：扣费', '你能那我咋滴', '2023-03-13 21:55:26', 0, 1, 0, 0);
INSERT INTO `email` VALUES (3, 33, 1, '哪里违规', '哪里违规？', '2023-03-13 14:03:30', 1, 0, 0, 0);
INSERT INTO `email` VALUES (4, 33, 1, '还好', '哈哈哈', '2023-03-13 14:12:37', 2, 0, 0, 0);
INSERT INTO `email` VALUES (5, 3, 33, '回复：还好', '呵呵呵', '2023-03-13 14:14:20', 0, 0, 0, 0);
...
CREATE TABLE `illegalinfo`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cardnum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '停车卡号',
  `illegalInfo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '违规信息',
  `parkin` datetime NULL DEFAULT NULL,
  `time` datetime NULL DEFAULT NULL COMMENT '违规时间',
  `uid` int(11) NULL DEFAULT 0 COMMENT '添加的管理员',
  `carnum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '车牌号，临时停车的话用车牌号记录',
  `deleted` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `illegalinfo` VALUES (1, '1581345771220180221', '666', '2018-05-22 16:35:00', '2023-03-13 17:36:33', 0, '黑A1R272', 'N');
INSERT INTO `illegalinfo` VALUES (2, '', '5555', '2018-05-22 16:48:05', '2023-03-13 17:48:46', 0, '555', 'N');
...
CREATE TABLE `income`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `money` double(20, 2) NULL DEFAULT 0.00 COMMENT '收入',
  `method` int(11) NULL DEFAULT 0 COMMENT '收入方式（0现金，1支付宝，2微信，9从卡中扣费）',
  `type` int(11) NULL DEFAULT 0 COMMENT '收入类型（0临时停车，1普通卡，2月卡，3年卡）',
  ...
  `isillegal` int(11) NULL DEFAULT 0 COMMENT '是否有违规',
  `source` int(11) NULL DEFAULT 1 COMMENT '收入来源，0充值卡，1出库收费',
  `time` datetime NULL DEFAULT NULL COMMENT '收入时间',
  `duration` bigint(20) NULL DEFAULT NULL COMMENT '停车时长',
  `trueincome` int(5) NULL DEFAULT 0 COMMENT '是否真正收入（0：否，1：是）',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `income` VALUES (174, 100.00, 1, 1, NULL, '1510016655120230307', 0, 0, '2023-03-07 16:57:00', 0, 0);
...
CREATE TABLE `parkinfo`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parknum` int(11) NULL DEFAULT NULL COMMENT '停车位号，对应parkspace的parkid',
  `cardnum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卡号',
  `carnum` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '车牌号',
  `parkin` datetime NULL DEFAULT NULL COMMENT '停入时间',
  `parktemp` int(11) NULL DEFAULT 0 COMMENT '0正常停车，1临时停车',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `parkinfoall`  (
  ...
  `carnum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `parkin` datetime NULL DEFAULT NULL,
  `parkout` datetime NULL DEFAULT NULL,
  `parktemp` int(11) NULL DEFAULT 0 COMMENT '0正常停车，1临时停车',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `parkspace`  (
  ...
  `parkid` int(11) NULL DEFAULT NULL COMMENT '车位号',
  `status` int(11) NULL DEFAULT 0 COMMENT '是否停车',
  `tag` int(11) NULL DEFAULT 1 COMMENT '停车类型，1：正常，2：临时，3紧急',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user`  (
  ...
  `tel` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '联系电话',
  `role` int(11) NULL DEFAULT 3 COMMENT '权限/职位（1超级管理员，2管理员，3用户）',
  `cardid` int(11) NULL DEFAULT 0 COMMENT '停车场卡（停车用户才有的）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '123456', '孟孟', '123456', '男', '123456', 2, 0);
INSERT INTO `user` VALUES (2, 'user1', '用户一号', 'user1', '男', '15100166551', 3, 0);
INSERT INTO `user` VALUES (3, '15100166551', '用户一号', '15100166551', '男', '15100166551', 3, 20);
