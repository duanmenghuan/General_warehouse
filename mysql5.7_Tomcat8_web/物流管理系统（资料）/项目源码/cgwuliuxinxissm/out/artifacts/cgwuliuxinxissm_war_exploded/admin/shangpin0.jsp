...
var url;
	...
	function openShangpinModifyDialog(){
		...
		$("#fm").form("load",row);
		url="../addSpjin?shangpinId="+row.shangpinId;
	}
...
<!--startprint-->
	...
	<div id="tb">
		<div>
			<a href="javascript:openShangpinModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">运输</a>
			<a href="javascript:shenheShangpin()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">拒绝</a>
		</div>
		<div>
