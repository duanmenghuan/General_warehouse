...
<div class="header bg-main">
  ...
  <div class="head-l">
  	<a class="button button-little bg-green"><span class="icon-home"></span><%=yonghuXingming %></a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="yonghu/yonghu.jsp" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
    <li><a href="yonghumima.jsp" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
  </ul>
