      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" class="form-horizontal" method="post" name="form1" action="mimaYonghu" onSubmit="return check()">
              <div id="form-wizard-1" class="step">
                <div class="control-group">
                  <label class="control-label">原密码</label>
                  <div class="controls">
                    <input id="yonghuPassword" type="password" name="yonghuPassword" />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">新密码</label>
                  <div class="controls">
                    <input id="yonghuPassword1" type="password" name="yonghuPassword1" />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">再一遍</label>
                  <div class="controls">
                    <input id="yonghuPassword2" type="password" name="yonghuPassword2" />
                  </div>
                </div>
              </div>
