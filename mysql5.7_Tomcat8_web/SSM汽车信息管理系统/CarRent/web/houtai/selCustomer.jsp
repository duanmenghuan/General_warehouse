        ...
        $(function () {
            ...
            $("#sc").click(function () {
                ...
                if (c == null) {
                    ...
                    $.messager.confirm("确认", "确定要删除[" + c.custname + "]么？", function (r) {
                        if (r) {
                            $.get("del.action", {"identity": c.identity}, function (f) {
                                msg = "";
                                if (f > 0) {
                                    msg = "删除成功";
                                    $("#tb").datagrid("reload");
...
<div id="tool">
    ...
    用户名<input class="easyui-textbox" id="custname" name="custname"/>
...
<div align="center">
    <form id="xgck" method="post">
        <table>
            <tr>
                <td>用户名:</td>
                <td><input class="easyui-textbox" data-options="required:true" name="custname"></td>
            </tr>
            <tr>
                <td>身份证号:</td>
