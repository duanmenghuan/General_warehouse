	 ...
	 pagination="true" url="../getUsers" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="userMark1" width="40">邮箱</th>
	...
	<div id="dlg" class="easyui-dialog" style="width: 540px;height: 360px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>备注3：</td>
					<td><input type="text" name="userMark3" id="userMark3" class="easyui-validatebox" required="true"/></td>
					<td>备注4：</td>
					<td><input type="text" name="userMark4" id="userMark4" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>时间1：</td>
					<td><input class="easyui-datetimebox" name="userDate1" id="userDate1" required="true" editable="false" /></td>
					<td>时间2：</td>
					<td><input class="easyui-datetimebox" name="userDate2" id="userDate2" required="true" editable="false" /></td>
				</tr>
				<tr>
					<td>类型1：</td>
					<td><select class="easyui-combobox" id="userType1" name="userType1" editable="false" panelHeight="auto" style="width: 155px">
					    <option value="">请选择...</option>
						<option value="0">零</option>
						<option value="1">一</option>
					</select></td>
					<td>类型2：</td>
					<td><select class="easyui-combobox" id="userType2" name="userType2" editable="false" panelHeight="auto" style="width: 155px">
					    <option value="">请选择...</option>
