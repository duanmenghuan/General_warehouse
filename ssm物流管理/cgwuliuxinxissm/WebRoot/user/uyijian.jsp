...
<!--startprint-->
	<table id="dg" title="反馈信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getUyijians?userId=<%=userId %>" fit="true" toolbar="#tb">
		<thead>
			<tr>
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>
					...
					<td>备注：</td>
					<td><input type="text" name="uyijianMark" id="uyijianMark" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td valign="top">描述：</td>
					<td colspan="4"><textarea rows="7" cols="50" name="uyijianMark1" id="uyijianMark1"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
