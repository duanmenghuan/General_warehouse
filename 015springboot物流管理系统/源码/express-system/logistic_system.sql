...
CREATE TABLE `t_permission`  (
  ...
  `type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限类型(menu 菜单权限，permission：普通权限)',
  `url` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限跳转url地址',
  `expression` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '权限表达式（shiro权限判断使用）',
...
CREATE TABLE `t_role`  (
  ...
  `remark` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色备注',
  `permission_ids` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色id，多个角色使用逗号隔开 1,2,3,4',
...
CREATE TABLE `t_user`  (
  ...
  `realname` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '真实名称',
  `password` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密码',
  `salt` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '盐(密码加密用)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 117 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (13, 'admin', 'Oza', '1093d2913f3c13a56e42279c331260fa', 'abcd', 1, '2023-04-15', 1);
INSERT INTO `t_user` VALUES (25, 'carlos', 'Carlos', '1ada7bd1901fce4bc9099421ecf69d6f', '62e7', 1, '2023-04-15', 2);
INSERT INTO `t_user` VALUES (27, 'lucy', 'lucy', 'd9db0dd54bcbd6b6811a8c778f40610f', 'ca4f', 1, '2023-04-15', 3);
INSERT INTO `t_user` VALUES (28, 'kitty', 'kitty', '686714c471734aa84171ff4a3da83cd5', '4935', 1, '2023-04-15', 4);
INSERT INTO `t_user` VALUES (29, 'carol', 'carol', '0c577fce2470bbcf611d1e32cd72e4b3', '095a', 1, '2023-04-15', 3);
INSERT INTO `t_user` VALUES (30, 'jack', 'jack', '2a47d88df0daf0537bb064783af8e798', '8f5b', 1, '2023-04-15', 3);
INSERT INTO `t_user` VALUES (31, 'lucas', 'lucas', '3dd41f2926f7fcacc2fec8d889614d68', 'e555', 1, '2023-04-15', 6);
INSERT INTO `t_user` VALUES (32, 'mike', 'mike', '188f9c61a31d1a782bb7279a2efa8ef0', '8b23', 1, '2023-04-15', 5);
INSERT INTO `t_user` VALUES (115, 'dragonlee', '李小龙', 'bfd26945551f65f3f281f675a1e27c51', '77a9', NULL, '2023-04-15', 6);
INSERT INTO `t_user` VALUES (116, 'zhangsan', '老六', '841046c508b1aac140f9b1ad0475ae33', '617d', NULL, '2023-04-15', 2);
